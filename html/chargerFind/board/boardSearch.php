...
<?php
    ...
    if($page != 1){
        $prevPage = $page -1;
        echo "<li><a href='boardSearch.php?page={$prevPage}&searchKeyword={$searchKeyword}'>이전</a></li>";
    }
    ...
    //마지막 페이지
    if($page != 30){        
        echo "<li><a href='boardSearch.php?page=30&searchKeyword={$searchKeyword}'>마지막으로</a></li>";
    }
