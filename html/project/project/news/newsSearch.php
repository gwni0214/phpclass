        ...
        if($result){
            ...
            if($result > 0){
                for($i=1; $i<=$count; $i++){
                    ...
                    echo "<div class='news__title'><a href='newsView.php?newsdID=".$boardInfo['newsID']."'>".$boardInfo['newsTitle']."</a></div>";
                    echo "<div class='news__desc'><a href='newsView.php?newsdID=".$boardInfo['newsID']."'>".$boardInfo['newsContents']."</a></div>";
