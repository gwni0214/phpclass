                    ...
                    <fieldset>
                        ...
                        <div class="join-box">
                            ...
                            <div class="basic">
                                ...
                                <input type="password" id="youPassC" name="youPassC" maxlength="20" placeholder="다시 비밀번호를 적어주세요!" required>
    ...
    <script>
        ...
        function nickChecking(){
            ...
            function joinChecks(){
                ...
                //이메일 유효성 검사
                let getmail = RegExp(/[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*.[a-zA-Z]$/i);
                ...
                //닉네임 유효성 검사
                let getnick = RegExp(/^[가-힣0-9]*$/);
                if(!getnick.test($("#youNickName").val())){
                    $("#youNickNameComment").text("닉네임 한글, 숫자로만 입력해주세요!");
                    $("#youNickName").val("");
                    return false;
                }
                ...
                if(!getname.test($("#youName").val())){
                    $("#youNameComment").text("한글로만 입력해주세요!");
                    $("#youName").val("");
                    return false;
                }
                ...
                if(!getbirth.test($("#youBirth").val())){
                    $("#youBirthComment").text("생년월일(YYYY-MM-DD)을 형식에 맞게 입력해주세요!");
                    $("#youBirth").val("");
                    return false;
                }
                ...
                if(!getphone.test($("#youPhone").val())){
                    $("#youPhoneComment").text("휴대폰번호(000-0000-0000)를 형식에 맞게 입력해주세요!");
                    $("#youPhone").val("");
                    return false;
                }
