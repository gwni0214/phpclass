        ...
        <section id="blog-type" class="section center mb100 type gray">
            <div class="container">
                ...
                <p class="section__desc">
                    ...
                    문제에 대한 저작권은 본인한테 있으며, 다른 부분을 참고 하였다면 출처를 부탁드립니다.                  
                </p>
                <div class="quiz__inner">
                    <div class="qiuz__create">
                        <form action="quizCreateSave.php" name="quizCreate" method="post">
                            <fieldset>
                                ...
                                <div>
                                    <label for="quizDesc">문제에 대한 보충 설명(해당 부분이 필요없으면 안쓰셔도 됩니다.)</label>
                                    <textarea name="quizDesc" id="quizDesc" placeholder="문제에 대한 해설, 보기, 이미지 추가시 이용해주세요!"></textarea>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <textarea name="quizComment" id="quizComment" placeholder="문제가 틀렸을 경우 이해할 수 있는 해설을 작성해주세요."></textarea>
                                </div>
                                <div>
                                    <label for="quizSource">출처 표시 (출처가 있으면 작성해주세요!)</label>
                                    <textarea name="quizSource" id="quizSource" placeholder="만약 다른 문제를 인용하였다면 출처를 남겨주세요."></textarea>
                                </div>
                                <div class="quiz__btn">
