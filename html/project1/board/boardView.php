...
<body>
    ...
    $sql = "SELECT b.boardID, b.boardTitle, m.youName, b.regTime, b.boardView, b.boardLike, b.boardContents FROM myProject_Board b JOIN myProject m ON(m.memberID = b.memberID) WHERE b.boardID = {$boardID}";
